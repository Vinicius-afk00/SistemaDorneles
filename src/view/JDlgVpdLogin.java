 ...
 * @author u08538003160
 */
public class JDlgVpdLogin extends javax.swing.JDialog {

    /**
     * Creates new form JDlgVpdLogin
     */
    public JDlgVpdLogin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgVpdLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgVpdLogin dialog = new JDlgVpdLogin(new javax.swing.JFrame(), true);
